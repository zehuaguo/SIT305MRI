...
public class restaurant_list6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_restaurant_list6);

        ListView listView = (ListView)findViewById(R.id.listView6);

        restaurant_list6Activity.CustomAdapter customAdapter = new restaurant_list6Activity.CustomAdapter();
        ...
        Imagebutton14.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                openActivity_restaurant_list6();
            }
        });
    }

    public void openActivity_restaurant_list6() {
